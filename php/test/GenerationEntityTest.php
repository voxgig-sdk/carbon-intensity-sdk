...
class GenerationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CARBONINTENSITY_TEST_GENERATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function generation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CARBONINTENSITY_TEST_GENERATION_ENTID");
