...
{
    public function test_direct_load_stat(): void
    {
        $setup = stat_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-stat", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
