...
class RegionalDirectTest extends TestCase
{
    public function test_direct_list_regional(): void
    {
        $setup = regional_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-regional", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
