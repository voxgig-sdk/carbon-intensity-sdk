...
class StatEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CARBON_INTENSITY_TEST_STAT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function stat_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CARBON_INTENSITY_TEST_STAT_ENTID");
