...
class RegionalIntensityListEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->RegionalIntensityList(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->RegionalIntensityList(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CARBON_INTENSITY_TEST_REGIONAL_INTENSITY_LIST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function regional_intensity_list_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CARBON_INTENSITY_TEST_REGIONAL_INTENSITY_LIST_ENTID");
