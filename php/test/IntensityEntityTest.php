...
class IntensityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CARBONINTENSITY_TEST_INTENSITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function intensity_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CARBONINTENSITY_TEST_INTENSITY_ENTID");
