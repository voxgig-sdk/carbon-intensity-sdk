...
// CarbonIntensity SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CarbonIntensitySDK::test)
...
{
    private const SDK_CLASS = 'CarbonIntensitySDK';
    ...
    private const SDK_BASE = 'carbonintensity_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../carbonintensity_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
