...
class GenerationListDirectTest extends TestCase
{
    public function test_direct_list_generation_list(): void
    {
        $setup = generation_list_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-generation_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
