...
class IntensityFactorDirectTest extends TestCase
{
    public function test_direct_list_intensity_factor(): void
    {
        $setup = intensity_factor_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-intensity_factor", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
