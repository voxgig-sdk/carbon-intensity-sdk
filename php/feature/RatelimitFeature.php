...
// CarbonIntensity SDK ratelimit feature
...
class CarbonIntensityRatelimitFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _acquire(CarbonIntensityContext $ctx): void
    {
    ...
    private function _track(CarbonIntensityContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
