...
// CarbonIntensity SDK clienttrack feature
...
class CarbonIntensityClienttrackFeature extends CarbonIntensityBaseFeature
{
    ...
    public function PostConstruct(CarbonIntensityContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CarbonIntensity-SDK';
