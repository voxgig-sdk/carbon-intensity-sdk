...
// CarbonIntensity SDK cache feature
...
class CarbonIntensityCacheFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _through(CarbonIntensityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
