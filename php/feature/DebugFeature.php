...
// CarbonIntensity SDK debug feature
...
class CarbonIntensityDebugFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _finish(CarbonIntensityContext $ctx, bool $ok): void
    {
