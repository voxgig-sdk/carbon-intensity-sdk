...
// CarbonIntensity SDK streaming feature
...
class CarbonIntensityStreamingFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _iterate(CarbonIntensityResult $result): \Generator
    {
    ...
    private function _streamable(CarbonIntensityContext $ctx): bool
    {
