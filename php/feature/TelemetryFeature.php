...
// CarbonIntensity SDK telemetry feature
...
class CarbonIntensityTelemetryFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _close(CarbonIntensityContext $ctx, bool $ok): void
    {
