...
// CarbonIntensity SDK Stat entity
...
class StatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StatEntity($this->_client, $opts);
    }

    /**
     * @param Stat|array $args Stat data (assoc-array) to store.
     */
    ...
    /**
     * @return Stat|array The current Stat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Stat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Stat fields).
     */
     ...
     * Load a single Stat.
     *
     * @param StatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Stat|array The loaded Stat as an assoc-array at the
