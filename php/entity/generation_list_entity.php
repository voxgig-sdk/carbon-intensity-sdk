...
class GenerationListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenerationListEntity($this->_client, $opts);
    }

    /**
     * @param GenerationList|array $args GenerationList data (assoc-array) to store.
     */
    ...
    /**
     * @return GenerationList|array The current GenerationList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenerationList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenerationList fields).
     */
     ...
     *
     * @param GenerationListListMatch|array|null $reqmatch Match filter (any subset
     *   of GenerationList fields) as an assoc-array; GenerationListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenerationList[]|array A list of GenerationList items as assoc-arrays at
