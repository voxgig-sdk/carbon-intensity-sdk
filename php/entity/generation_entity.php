...
// CarbonIntensity SDK Generation entity
...
class GenerationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenerationEntity($this->_client, $opts);
    }

    /**
     * @param Generation|array $args Generation data (assoc-array) to store.
     */
    ...
    /**
     * @return Generation|array The current Generation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Generation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Generation fields).
     */
     ...
     *
     * @param GenerationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenerationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Generation|array The loaded Generation as an assoc-array at the
     ...
     *
     * @param GenerationListMatch|array|null $reqmatch Match filter (any subset
     *   of Generation fields) as an assoc-array; GenerationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Generation[]|array A list of Generation items as assoc-arrays at
