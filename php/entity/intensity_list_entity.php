...
// CarbonIntensity SDK IntensityList entity
...
class IntensityListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IntensityListEntity($this->_client, $opts);
    }

    /**
     * @param IntensityList|array $args IntensityList data (assoc-array) to store.
     */
    ...
    /**
     * @return IntensityList|array The current IntensityList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IntensityList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IntensityList fields).
     */
    ...
    /**
     * Load a single IntensityList.
     *
     * @param IntensityListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IntensityListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntensityList|array The loaded IntensityList as an assoc-array at the
    ...
    /**
     * List IntensityList items matching the given filter.
     *
     * @param IntensityListListMatch|array|null $reqmatch Match filter (any subset
     *   of IntensityList fields) as an assoc-array; IntensityListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntensityList[]|array A list of IntensityList items as assoc-arrays at
