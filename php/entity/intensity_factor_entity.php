...
class IntensityFactorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IntensityFactorEntity($this->_client, $opts);
    }

    /**
     * @param IntensityFactor|array $args IntensityFactor data (assoc-array) to store.
     */
    ...
    /**
     * @return IntensityFactor|array The current IntensityFactor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IntensityFactor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IntensityFactor fields).
     */
     ...
     *
     * @param IntensityFactorListMatch|array|null $reqmatch Match filter (any subset
     *   of IntensityFactor fields) as an assoc-array; IntensityFactorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IntensityFactor[]|array A list of IntensityFactor items as assoc-arrays at
