...
// CarbonIntensity SDK utility: graphql
//
...
class CarbonIntensityGraphql
{
    ...
    // equivalent.
    public static function body(CarbonIntensityContext $ctx): mixed
    {
    ...
    public static function errors(CarbonIntensityContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
