...
// CarbonIntensity SDK utility: make_options

class CarbonIntensityMakeOptions
{
    ...
    public static function call(CarbonIntensityContext $ctx): array
    {
        ...
        //
        // `CarbonIntensitySchema::optspec()` is built from the model:
        ...
        $optspec = CarbonIntensitySchema::optspec();
