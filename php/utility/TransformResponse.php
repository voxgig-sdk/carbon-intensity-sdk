...
// CarbonIntensity SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CarbonIntensityTransformResponse
{
    public static function call(CarbonIntensityContext $ctx): mixed
    {
        ...
        $transform = CarbonIntensityHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
