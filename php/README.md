...
The PHP SDK for the CarbonIntensity API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Generation(null)->list(null, null);
...
[$result, $err] = $client->CarbonIntensity(null)->load(
    ["id" => "test01"], null
);
