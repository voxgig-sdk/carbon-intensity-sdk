...
function runner.env_override(m)
  local live = runner.getenv("CARBON_INTENSITY_TEST_LIVE")
  local override = runner.getenv("CARBON_INTENSITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CARBON_INTENSITY_TEST_EXPLAIN")
