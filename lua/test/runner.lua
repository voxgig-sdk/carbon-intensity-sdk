...
function runner.env_override(m)
  local live = runner.getenv("CARBONINTENSITY_TEST_LIVE")
  local override = runner.getenv("CARBONINTENSITY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CARBONINTENSITY_TEST_EXPLAIN")
