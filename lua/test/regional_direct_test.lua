...
describe("RegionalDirect", function()
  it("should direct-list-regional", function()
    local setup = regional_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-regional", setup.live and "live" or "unit")
...
function regional_direct_setup(mockres)
