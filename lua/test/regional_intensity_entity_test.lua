...
describe("RegionalIntensityEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:RegionalIntensity(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:RegionalIntensity(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CARBON_INTENSITY_TEST_REGIONAL_INTENSITY_ENTID JSON to run live")
      return
    end
...
function regional_intensity_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CARBON_INTENSITY_TEST_REGIONAL_INTENSITY_ENTID")
