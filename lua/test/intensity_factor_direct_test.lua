...
describe("IntensityFactorDirect", function()
  it("should direct-list-intensity_factor", function()
    local setup = intensity_factor_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-intensity_factor", setup.live and "live" or "unit")
...
function intensity_factor_direct_setup(mockres)
