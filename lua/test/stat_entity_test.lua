...
describe("StatEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CARBONINTENSITY_TEST_STAT_ENTID JSON to run live")
      return
    end
...
function stat_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CARBONINTENSITY_TEST_STAT_ENTID")
