...
describe("GenerationListDirect", function()
  it("should direct-list-generation_list", function()
    local setup = generation_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-generation_list", setup.live and "live" or "unit")
...
function generation_list_direct_setup(mockres)
