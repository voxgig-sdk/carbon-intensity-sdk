...
describe("GenerationListEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:GenerationList(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:GenerationList(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CARBON_INTENSITY_TEST_GENERATION_LIST_ENTID JSON to run live")
      return
    end
...
function generation_list_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CARBON_INTENSITY_TEST_GENERATION_LIST_ENTID")
