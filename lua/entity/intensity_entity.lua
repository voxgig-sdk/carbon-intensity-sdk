...
local IntensityEntity = {}
IntensityEntity.__index = IntensityEntity


function IntensityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IntensityEntity)
  self._name = "intensity"
  self._client = client
...
function IntensityEntity:get_name()
  return self._name
end


function IntensityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IntensityEntity.new(self._client, opts)
end
...
function IntensityEntity:mark_deleted()
  self._deleted = true
end


function IntensityEntity:deleted()
  return true == self._deleted
end


function IntensityEntity:data_set(args)
  if args ~= nil then
...
function IntensityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IntensityEntity:match_set(args)
  if args ~= nil then
...
function IntensityEntity:match_get()
...
function IntensityEntity:stream(action, args, callopts)
...
---@param reqmatch IntensityLoadMatch
---@param ctrl? table
---@return Intensity
---@return string? err
function IntensityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch IntensityListMatch
---@param ctrl? table
---@return Intensity[]
---@return string? err
function IntensityEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function IntensityEntity:_run_op(ctx, post_done)
  local utility = self._utility
