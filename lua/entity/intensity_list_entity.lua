...
local IntensityListEntity = {}
IntensityListEntity.__index = IntensityListEntity


function IntensityListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IntensityListEntity)
  self._name = "intensity_list"
  self._client = client
...
function IntensityListEntity:get_name()
  return self._name
end


function IntensityListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IntensityListEntity.new(self._client, opts)
end
...
function IntensityListEntity:mark_deleted()
  self._deleted = true
end


function IntensityListEntity:deleted()
  return true == self._deleted
end


function IntensityListEntity:data_set(args)
  if args ~= nil then
...
function IntensityListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IntensityListEntity:match_set(args)
  if args ~= nil then
...
function IntensityListEntity:match_get()
...
function IntensityListEntity:stream(action, args, callopts)
...
function IntensityListEntity:_run_op(ctx, post_done)
  local utility = self._utility
