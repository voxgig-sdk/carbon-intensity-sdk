...
local RegionalIntensityEntity = {}
RegionalIntensityEntity.__index = RegionalIntensityEntity


function RegionalIntensityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegionalIntensityEntity)
  self._name = "regional_intensity"
  self._client = client
...
function RegionalIntensityEntity:get_name()
  return self._name
end


function RegionalIntensityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RegionalIntensityEntity.new(self._client, opts)
end
...
function RegionalIntensityEntity:mark_deleted()
  self._deleted = true
end


function RegionalIntensityEntity:deleted()
  return true == self._deleted
end


function RegionalIntensityEntity:data_set(args)
  if args ~= nil then
...
function RegionalIntensityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegionalIntensityEntity:match_set(args)
  if args ~= nil then
...
function RegionalIntensityEntity:match_get()
...
function RegionalIntensityEntity:stream(action, args, callopts)
...
function RegionalIntensityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegionalIntensityEntity
