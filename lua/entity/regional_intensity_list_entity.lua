...
local RegionalIntensityListEntity = {}
RegionalIntensityListEntity.__index = RegionalIntensityListEntity


function RegionalIntensityListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegionalIntensityListEntity)
  self._name = "regional_intensity_list"
  self._client = client
...
function RegionalIntensityListEntity:get_name()
  return self._name
end


function RegionalIntensityListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RegionalIntensityListEntity.new(self._client, opts)
end
...
function RegionalIntensityListEntity:mark_deleted()
  self._deleted = true
end


function RegionalIntensityListEntity:deleted()
  return true == self._deleted
end


function RegionalIntensityListEntity:data_set(args)
  if args ~= nil then
...
function RegionalIntensityListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegionalIntensityListEntity:match_set(args)
  if args ~= nil then
...
function RegionalIntensityListEntity:match_get()
...
function RegionalIntensityListEntity:stream(action, args, callopts)
...
---@param reqmatch RegionalIntensityListLoadMatch
---@param ctrl? table
---@return RegionalIntensityList
---@return string? err
function RegionalIntensityListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RegionalIntensityListListMatch
---@param ctrl? table
---@return RegionalIntensityList[]
---@return string? err
function RegionalIntensityListEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function RegionalIntensityListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegionalIntensityListEntity
