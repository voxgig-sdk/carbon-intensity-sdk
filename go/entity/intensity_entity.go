...
func NewIntensityEntity(client *core.CarbonIntensitySDK, entopts map[string]any) *IntensityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntensityEntity) GetName() string { return e.name }
...
func (e *IntensityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IntensityEntity) Deleted() bool {
	return e.deleted
}


func (e *IntensityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIntensityEntity(e.client, opts)
}

func (e *IntensityEntity) Data(args ...any) any {
...
func (e *IntensityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *IntensityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IntensityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *IntensityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IntensityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IntensityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IntensityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
