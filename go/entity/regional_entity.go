...
func NewRegionalEntity(client *core.CarbonIntensitySDK, entopts map[string]any) *RegionalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegionalEntity) GetName() string { return e.name }
...
func (e *RegionalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegionalEntity) Deleted() bool {
	return e.deleted
}


func (e *RegionalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegionalEntity(e.client, opts)
}

func (e *RegionalEntity) Data(args ...any) any {
...
func (e *RegionalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Regional; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RegionalEntity) DataTyped(data ...Regional) Regional {
	if len(data) > 0 {
		return typedFrom[Regional](e.Data(asMap(data[0])))
	}
	return typedFrom[Regional](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Regional (all fields
// optional at the wire level).
func (e *RegionalEntity) MatchTyped(match ...Regional) Regional {
	if len(match) > 0 {
		return typedFrom[Regional](e.Match(asMap(match[0])))
	}
	return typedFrom[Regional](e.Match())
}
...
func (e *RegionalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegionalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RegionalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RegionalListMatch and returns []Regional. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RegionalEntity) ListTyped(reqmatch RegionalListMatch, ctrl map[string]any) ([]Regional, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Regional](res), nil
}



func (e *RegionalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RegionalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegionalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegionalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
