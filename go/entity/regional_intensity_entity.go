...
type RegionalIntensityEntity struct {
	name    string
...
func NewRegionalIntensityEntity(client *core.CarbonIntensitySDK, entopts map[string]any) *RegionalIntensityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegionalIntensityEntity) GetName() string { return e.name }
...
func (e *RegionalIntensityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegionalIntensityEntity) Deleted() bool {
	return e.deleted
}


func (e *RegionalIntensityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegionalIntensityEntity(e.client, opts)
}

func (e *RegionalIntensityEntity) Data(args ...any) any {
...
func (e *RegionalIntensityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *RegionalIntensityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegionalIntensityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *RegionalIntensityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RegionalIntensityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegionalIntensityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegionalIntensityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
