...
func (e *GenerationListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenerationListEntity) Deleted() bool {
	return e.deleted
}
...
func (e *GenerationListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
