...
type IntensityFactorEntity struct {
	name    string
...
func NewIntensityFactorEntity(client *core.CarbonIntensitySDK, entopts map[string]any) *IntensityFactorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntensityFactorEntity) GetName() string { return e.name }
...
func (e *IntensityFactorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IntensityFactorEntity) Deleted() bool {
	return e.deleted
}


func (e *IntensityFactorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIntensityFactorEntity(e.client, opts)
}

func (e *IntensityFactorEntity) Data(args ...any) any {
...
func (e *IntensityFactorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IntensityFactor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IntensityFactorEntity) DataTyped(data ...IntensityFactor) IntensityFactor {
	if len(data) > 0 {
		return typedFrom[IntensityFactor](e.Data(asMap(data[0])))
	}
	return typedFrom[IntensityFactor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IntensityFactor (all fields
// optional at the wire level).
func (e *IntensityFactorEntity) MatchTyped(match ...IntensityFactor) IntensityFactor {
	if len(match) > 0 {
		return typedFrom[IntensityFactor](e.Match(asMap(match[0])))
	}
	return typedFrom[IntensityFactor](e.Match())
}
...
func (e *IntensityFactorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IntensityFactorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *IntensityFactorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IntensityFactorListMatch and returns []IntensityFactor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *IntensityFactorEntity) ListTyped(reqmatch IntensityFactorListMatch, ctrl map[string]any) ([]IntensityFactor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[IntensityFactor](res), nil
}



func (e *IntensityFactorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IntensityFactorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IntensityFactorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IntensityFactorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
