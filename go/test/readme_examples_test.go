...
const testSeed = `map[string]any{"entity": map[string]any{"generation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generation_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "intensity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "intensity_factor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "intensity_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "regional": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "regional_intensity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "regional_intensity_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stat": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
