...
## Install
```bash
go get github.com/voxgig-sdk/carbon-intensity-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/carbon-intensity-sdk=../path/to/github.com/voxgig-sdk/carbon-intensity-sdk
```
...
```
github.com/voxgig-sdk/carbon-intensity-sdk/
...
The root package (`github.com/voxgig-sdk/carbon-intensity-sdk`) re-exports everything needed
