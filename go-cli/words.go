...
func registerSDKWords(r *eng.Registry, client *sdk.CarbonIntensitySDK) {
...
func runOp(client *sdk.CarbonIntensitySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
