...
class RegionalEntity extends CarbonIntensityEntityBase_1.CarbonIntensityEntityBase {
    ...
    make() {
        return new RegionalEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Regional[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.RegionalEntity = RegionalEntity;
//# sourceMappingURL=RegionalEntity.js.map