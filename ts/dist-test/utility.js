...
function envOverride(m) {
    if ('TRUE' === process.env.CARBON_INTENSITY_TEST_LIVE ||
        'TRUE' === process.env.CARBON_INTENSITY_TEST_OVERRIDE) {
    ...
    m.CARBON_INTENSITY_TEST_EXPLAIN = process.env.CARBON_INTENSITY_TEST_EXPLAIN || m.CARBON_INTENSITY_TEST_EXPLAIN;
    return m;
}
