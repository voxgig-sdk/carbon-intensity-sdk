...
(0, node_test_1.describe)('RegionalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-regional', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-regional', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_REGIONAL_ENTID'];
...
//# sourceMappingURL=RegionalDirect.test.js.map