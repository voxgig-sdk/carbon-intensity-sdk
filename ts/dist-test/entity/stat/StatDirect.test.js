...
(0, node_test_1.describe)('StatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-stat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["block01", "from01", "to01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_STAT_ENTID'];
...
//# sourceMappingURL=StatDirect.test.js.map