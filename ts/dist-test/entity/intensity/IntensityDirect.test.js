...
(0, node_test_1.describe)('IntensityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-intensity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-intensity', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["date01", "period01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-intensity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-intensity', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CARBON_INTENSITY_TEST_INTENSITY_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_INTENSITY_ENTID'];
...
//# sourceMappingURL=IntensityDirect.test.js.map