...
(0, node_test_1.describe)('GenerationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-generation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["from01", "to01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-generation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-generation', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_GENERATION_ENTID'];
...
//# sourceMappingURL=GenerationDirect.test.js.map