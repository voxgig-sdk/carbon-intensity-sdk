...
(0, node_test_1.describe)('IntensityFactorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-intensity_factor', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-intensity_factor', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_INTENSITY_FACTOR_ENTID'];
...
//# sourceMappingURL=IntensityFactorDirect.test.js.map