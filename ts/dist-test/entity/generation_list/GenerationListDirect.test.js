...
(0, node_test_1.describe)('GenerationListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-generation_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-generation_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CARBON_INTENSITY_TEST_GENERATION_LIST_ENTID'];
...
//# sourceMappingURL=GenerationListDirect.test.js.map