...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/carbon-intensity` | `npm install @voxgig-sdk/carbon-intensity` |
| Python | `voxgig-sdk-carbon-intensity` | `pip install voxgig-sdk-carbon-intensity` |
| PHP | `voxgig-sdk/carbon-intensity` | `composer require voxgig-sdk/carbon-intensity` |
| Golang | `github.com/voxgig-sdk/carbon-intensity-sdk/go` | `go get github.com/voxgig-sdk/carbon-intensity-sdk/go` |
| Ruby | `voxgig-sdk-carbon-intensity` | `gem install voxgig-sdk-carbon-intensity` |
| Lua | `voxgig-sdk-carbon-intensity` | `luarocks install voxgig-sdk-carbon-intensity` |
