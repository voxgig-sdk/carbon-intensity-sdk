# CarbonIntensity SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CarbonIntensitySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CarbonIntensitySDK(...) and CarbonIntensitySDK.test(...) become
#      CarbonIntensitySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "carbonintensity_sdk"
_SDK_CLASS = "CarbonIntensitySDK"
...
_ENTITIES = {
    ...
    "GenerationList": "generation_list",
    "Intensity": "intensity",
    "IntensityFactor": "intensity_factor",
    "IntensityList": "intensity_list",
    "Regional": "regional",
    "RegionalIntensity": "regional_intensity",
    "RegionalIntensityList": "regional_intensity_list",
    "Stat": "stat",
}
