...
from carbonintensity_sdk.utility import register

# Load features
from carbonintensity_sdk.feature.base_feature import CarbonIntensityBaseFeature
from carbonintensity_sdk.features import _has_feature, _make_feature
...
class CarbonIntensitySDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "CarbonIntensitySDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CarbonIntensitySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Generation(self, data=None) -> "GenerationEntity":
        ...
        from carbonintensity_sdk.entity.generation_entity import GenerationEntity
    ...
    def GenerationList(self, data=None) -> "GenerationListEntity":
        ...
        from carbonintensity_sdk.entity.generation_list_entity import GenerationListEntity
    ...
    def Intensity(self, data=None) -> "IntensityEntity":
        ...
        from carbonintensity_sdk.entity.intensity_entity import IntensityEntity
    ...
    def IntensityFactor(self, data=None) -> "IntensityFactorEntity":
        ...
        from carbonintensity_sdk.entity.intensity_factor_entity import IntensityFactorEntity
    ...
    def IntensityList(self, data=None) -> "IntensityListEntity":
        ...
        from carbonintensity_sdk.entity.intensity_list_entity import IntensityListEntity
    ...
    def Regional(self, data=None) -> "RegionalEntity":
        ...
        from carbonintensity_sdk.entity.regional_entity import RegionalEntity
    ...
    def RegionalIntensity(self, data=None) -> "RegionalIntensityEntity":
        ...
        from carbonintensity_sdk.entity.regional_intensity_entity import RegionalIntensityEntity
    ...
    def RegionalIntensityList(self, data=None) -> "RegionalIntensityListEntity":
        ...
        from carbonintensity_sdk.entity.regional_intensity_list_entity import RegionalIntensityListEntity
    ...
    def Stat(self, data=None) -> "StatEntity":
        ...
        from carbonintensity_sdk.entity.stat_entity import StatEntity
        return StatEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CarbonIntensitySDK":
        if sdkopts is None:
            sdkopts = {}
