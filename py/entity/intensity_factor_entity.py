...
class IntensityFactorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IntensityFactorEntity(self._client, opts)
    ...
    def data_get(self) -> IntensityFactor:
    ...
    def match_get(self) -> IntensityFactor:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[IntensityFactor]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.IntensityFactor().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
