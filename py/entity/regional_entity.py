...
class RegionalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegionalEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Regional]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Regional().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
