...
class GenerationListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerationListEntity(self._client, opts)
    ...
    def data_get(self) -> GenerationList:
    ...
    def match_get(self) -> GenerationList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GenerationList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GenerationList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
