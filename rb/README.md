...
The Ruby SDK for the CarbonIntensity API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.CarbonIntensity(nil).load(
  { "id" => "test01" }, nil
)
