...
class StatEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CARBON_INTENSITY_TEST_STAT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def stat_basic_setup(extra)
  ...
  entid_env_raw = ENV["CARBON_INTENSITY_TEST_STAT_ENTID"]
