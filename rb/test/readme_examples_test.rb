...
#      offline in seeded test mode (CarbonIntensitySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CarbonIntensity_sdk.rb")
  SDK_CLASS = "CarbonIntensitySDK"
