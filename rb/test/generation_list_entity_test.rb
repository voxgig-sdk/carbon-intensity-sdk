...
class GenerationListEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CARBONINTENSITY_TEST_GENERATION_LIST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def generation_list_basic_setup(extra)
  ...
  entid_env_raw = ENV["CARBONINTENSITY_TEST_GENERATION_LIST_ENTID"]
