...
class IntensityFactorEntity
  ...
  def make
    opts = @_entopts.dup
    IntensityFactorEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [IntensityFactorListMatch, Hash, nil] match filter (any subset of
  #   IntensityFactor fields); defaults to nil, treated as an empty match that lists all.
