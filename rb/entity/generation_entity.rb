...
class GenerationEntity
  ...
  def make
    opts = @_entopts.dup
    GenerationEntity.new(@_client, opts)
  end
  ...
  # @return [Generation, Hash] the current Generation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Generation fields)
  def match_get
  ...
  #
  # @param reqmatch [GenerationListMatch, Hash, nil] match filter (any subset of
  #   Generation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Generation>, Array] the matching Generation items; raises CarbonIntensityError on failure
