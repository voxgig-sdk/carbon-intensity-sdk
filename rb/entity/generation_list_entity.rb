...
class GenerationListEntity
  ...
  def make
    opts = @_entopts.dup
    GenerationListEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GenerationListListMatch, Hash, nil] match filter (any subset of
  #   GenerationList fields); defaults to nil, treated as an empty match that lists all.
