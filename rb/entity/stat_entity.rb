...
class StatEntity
  ...
  #
  # @param reqmatch [StatListMatch, Hash, nil] match filter (any subset of
  #   Stat fields); defaults to nil, treated as an empty match that lists all.
