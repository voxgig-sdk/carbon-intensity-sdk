...
class RegionalEntity
  ...
  def make
    opts = @_entopts.dup
    RegionalEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [RegionalListMatch, Hash, nil] match filter (any subset of
  #   Regional fields); defaults to nil, treated as an empty match that lists all.
