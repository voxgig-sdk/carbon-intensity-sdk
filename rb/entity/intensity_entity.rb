...
class IntensityEntity
  ...
  def make
    opts = @_entopts.dup
    IntensityEntity.new(@_client, opts)
  end
  ...
  # @return [Intensity, Hash] the current Intensity data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Intensity fields)
  def match_get
  ...
  #
  # @param reqmatch [IntensityLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Intensity.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Intensity, Hash] the loaded Intensity; raises CarbonIntensityError on failure
  ...
  #
  # @param reqmatch [IntensityListMatch, Hash, nil] match filter (any subset of
  #   Intensity fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Intensity>, Array] the matching Intensity items; raises CarbonIntensityError on failure
