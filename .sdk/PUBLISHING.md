...
|---|---|---|
| `ts/` | @voxgig-sdk/carbon-intensity-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/carbon-intensity-sdk \
      --repository voxgig-sdk/carbon-intensity-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/carbon-intensity-sdk` shows it, and
`npm trust revoke @voxgig-sdk/carbon-intensity-sdk --id=<id>` removes it.
