...
// CarbonIntensity SDK utility: result_basic

class CarbonIntensityResultBasic
{
    public static function call(CarbonIntensityContext $ctx): ?CarbonIntensityResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CarbonIntensityError) ? $result->err->msg : (string)$result->err;
