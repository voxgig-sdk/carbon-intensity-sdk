...
// CarbonIntensity SDK utility: fetcher
...
class CarbonIntensityFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CarbonIntensitySDK/1.0)';
    ...
    public static function call(CarbonIntensityContext $ctx, string $fullurl, array $fetchdef): array
    {
