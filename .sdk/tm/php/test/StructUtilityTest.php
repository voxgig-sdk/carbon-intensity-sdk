...
// CarbonIntensity SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CarbonIntensityOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CarbonIntensityOmni::structfix($now, Struct::undef()))
                        !== json_encode(CarbonIntensityOmni::structfix($val, Struct::undef()))) {
