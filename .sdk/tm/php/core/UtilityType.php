...
// CarbonIntensity SDK utility type

class CarbonIntensityUtility
{
    ...
    public static function copy(CarbonIntensityUtility $src): CarbonIntensityUtility
    {
        $u = new CarbonIntensityUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
