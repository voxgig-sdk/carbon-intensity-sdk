...
// CarbonIntensity SDK netsim feature
...
class CarbonIntensityNetsimFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _simulate(CarbonIntensityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CarbonIntensityContext $ctx, array $applied): void
    {
        $client = $this->client;
