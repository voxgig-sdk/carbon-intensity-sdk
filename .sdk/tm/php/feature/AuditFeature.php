...
// CarbonIntensity SDK audit feature
...
class CarbonIntensityAuditFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _emit(CarbonIntensityContext $ctx, string $outcome): void
    {
