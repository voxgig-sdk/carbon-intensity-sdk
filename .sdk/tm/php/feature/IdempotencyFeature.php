...
// CarbonIntensity SDK idempotency feature
...
class CarbonIntensityIdempotencyFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _mutating(CarbonIntensityContext $ctx): bool
    {
