...
// CarbonIntensity SDK timeout feature
...
class CarbonIntensityTimeoutFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _with_timeout(CarbonIntensityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CarbonIntensityContext $_ctx, float $ms): void
    {
        $client = $this->client;
