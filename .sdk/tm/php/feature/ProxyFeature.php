...
// CarbonIntensity SDK proxy feature
...
class CarbonIntensityProxyFeature extends CarbonIntensityBaseFeature
{
    ...
    public function init(CarbonIntensityContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CarbonIntensityContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
