...
// CarbonIntensity SDK metrics feature
...
class CarbonIntensityMetricsFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _record(CarbonIntensityContext $ctx, bool $ok): void
    {
