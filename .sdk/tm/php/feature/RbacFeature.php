...
// CarbonIntensity SDK rbac feature
...
class CarbonIntensityRbacFeature extends CarbonIntensityBaseFeature
{
    ...
    private function _required(CarbonIntensityContext $ctx): ?string
    {
    ...
    private function _reject(CarbonIntensityContext $ctx, string $required): void
    {
    ...
    private function _track(CarbonIntensityContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
