...
class CarbonIntensityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CarbonIntensityTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CarbonIntensityTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CarbonIntensityTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
