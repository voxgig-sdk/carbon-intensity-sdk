// Command CarbonIntensity-mcp is an MCP server exposing the CarbonIntensity
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CarbonIntensity_list  — list records of an entity
//	CarbonIntensity_load  — load a single record of an entity
//
