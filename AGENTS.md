# CarbonIntensity SDK — Agent Guide
...
**Entities** (9): `Generation`, `GenerationList`, `Intensity`, `IntensityFactor`, `IntensityList`, `Regional`, `RegionalIntensity`, `RegionalIntensityList`, `Stat`.
